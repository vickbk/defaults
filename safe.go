...
// Safe validates if the zero index value type matches type T of default value.
...
// Use instead Get for only one optional parameter for type safety.
//
// Example:
//
//	val, status := Safe(args, 10, "Age must be an int")
